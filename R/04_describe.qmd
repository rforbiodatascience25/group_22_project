...
-   Lipinski: whether the molecule follows Lipinski’s Rule of Five (MW ≤ 500, Clog P ≤ 5, HBD ≤ 5, HBA ≤ 10), indicating good likelihood of oral bioavailability.
...
ggsave(str_c(results_path,"Description_violin_plot.png"), plot = last_plot(), 
