...
drugbank_merged <- select(drugbank_merged, -"cas.x", -"cas.y", -"inchikey", -"name.x", -"name.y", -"synonyms", -"inchi", -"standard_inchi_key", -"accession_numbers", -"unii", -"kegg_compound_id", -"kegg_drug_id", -"pubchem_compound_id", -"pubchem_substance_id", -"chebi_id", -"ChEMBL ID", -"het_id", -"chemspider_id", -"bindingdb_id", -"uniprot_id", -"type")
