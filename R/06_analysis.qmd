...
ggsave(str_c(results_path,"Analysis2_HBD_count.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
ggsave(str_c(presentation_path,"Analysis2_HBD_count.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
hbd_hist
...
ggsave(str_c(results_path,"Analysis2_HBA_count.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
ggsave(str_c(presentation_path,"Analysis2_HBA_count.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
hba_hist
...
ggsave(str_c(results_path,"Analysis2_Lipinski_percent.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
...
mw_density <- df_drug |>
  ...
  labs(x = "Molecular Weight (MW)",
       y = "Density")
ggsave(str_c(results_path,"Analysis2_MW_density.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
ggsave(str_c(presentation_path,"Analysis2_MW_density.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
mw_density
...
logp_density <- df_drug |>
  ...
  labs(x = "LogP (ClogP)",
       y = "Density")
ggsave(str_c(results_path,"Analysis2_LogP_density.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
ggsave(str_c(presentation_path,"Analysis2_LogP_density.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
logp_density
```
...
ggsave(str_c(results_path,"Analysis2_HBD_SE.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
hbd_burden
...
ggsave(str_c(results_path,"Analysis2_HBA_SE.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
hba_burden
...
mw_burden <- df_drug |>
  ...
  labs(x = "Molecular Weight (MW)",
       y = "Number of Side Effects")
ggsave(str_c(results_path,"Analysis2_MW_SE.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
mw_burden
...
logp_burden <- df_drug |>
  ...
  labs(x = "LogP (ClogP)",
       y = "Number of Side Effects")
ggsave(str_c(results_path,"Analysis2_LogP_SE.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
...
ggsave(str_c(results_path,"Analysis2_Lipinski_Legal.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
ggsave(str_c(presentation_path,"Analysis2_Lipinski_Legal.png"), plot = last_plot(), 
       width = 8, height = 6, dpi = 300)
legal_plot
```
